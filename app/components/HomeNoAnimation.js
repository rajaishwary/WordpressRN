...
export default class HomeNoAnimation extends Component {
  ...
  state = {
    index: 0,
    routes: [
      { key: '1', title: 'Sports', icon: 'ios-star' }, //, icon: 'ios-star' 
      { key: '2', title: 'Trending', icon: 'ios-albums' },
      { key: '3', title: 'Message', icon: 'ios-navigate' },
      { key: '4', title: 'Profile', icon: 'ios-search' },
    ],
  };
